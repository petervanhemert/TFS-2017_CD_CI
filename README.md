...
Create a new local Git repo for your project by selecting <img src="/MD_Images/Capture%201.PNG" width="600"/>  Add to Source Control on the status bar in the lower right hand corner of Visual Studio. This will create a new repo in the folder the solution is in and commit your code into that repo.
